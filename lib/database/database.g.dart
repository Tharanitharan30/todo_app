...
class Subtask extends DataClass implements Insertable<Subtask> {
  ...
  Subtask copyWith({int? id, int? taskId, String? title, bool? completed}) =>
      Subtask(
        id: id ?? this.id,
...
class IncomeData extends DataClass implements Insertable<IncomeData> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, amount, source, date, note, isRecurring, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is IncomeData &&
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable<$IncomeTable, IncomeData>(table),
                  BaseReferences<_$AppDatabase, $IncomeTable, IncomeData>(
                    db,
                    table,
                    e,
                  ),
